        ...
        <div class="row">
            <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
                <div class="item">
                    <div class="event-bx">
                        <div class="action-box">
                            <img src="{{ asset('template') }}/assets/images/event/pic4.jpg" alt="">
                        </div>
                ...
                <div class="item">
                    <div class="event-bx">
                        <div class="action-box">
                            <img src="{{ asset('template') }}/assets/images/event/pic3.jpg" alt="">
                        </div>
                        <div class="info-bx d-flex">
                            <div>
                                <div class="event-time">
                ...
                <div class="item">
                    <div class="event-bx">
                        <div class="action-box">
                            <img src="{{ asset('template') }}/assets/images/event/pic2.jpg" alt="">
                        </div>
                        <div class="info-bx d-flex">
                            <div>
                                <div class="event-time">
