            ...
            <div class="row mb-5">
                <div class="col-lg-6 pe-lg-5" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="d-flex align-items-center mt-4 signature-block">
                        <img src="{{ asset('NiceSchool') }}/assets/img/misc/signature-1.webp" alt="Principal's Signature"
                            width="120">
                        <div class="ms-3">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                    <div class="image-stack">
                        <div class="image-stack-item image-stack-item-top" data-aos="zoom-in" data-aos-delay="400">
                            <img src="{{ asset('NiceSchool') }}/assets/img/education/campus-4.webp" alt="Campus Life"
                                class="img-fluid rounded-4 shadow-lg">
                        </div>
                        <div class="image-stack-item image-stack-item-bottom" data-aos="zoom-in" data-aos-delay="500">
                            <img src="{{ asset('NiceSchool') }}/assets/img/education/students-2.webp" alt="Students"
                                class="img-fluid rounded-4 shadow-lg">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="program-image-wrapper">
                                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-1.webp"
                    ...
                    <div class="col-lg-6 isotope-item filter-bachelor" data-aos="zoom-in" data-aos-delay="200">
                        <div class="program-item">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="program-image-wrapper">
                                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-3.webp"
                                            class="img-fluid" alt="Program">
                                    </div>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="col-lg-6 isotope-item filter-bachelor" data-aos="zoom-in" data-aos-delay="300">
                        <div class="program-item">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="program-image-wrapper">
                                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-5.webp"
                                            class="img-fluid" alt="Program">
                                    </div>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="col-lg-6 isotope-item filter-master" data-aos="zoom-in" data-aos-delay="100">
                        <div class="program-item">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="program-image-wrapper">
                                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-7.webp"
                                            class="img-fluid" alt="Program">
                                    </div>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="col-lg-6 isotope-item filter-master" data-aos="zoom-in" data-aos-delay="200">
                        <div class="program-item">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="program-image-wrapper">
                                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-9.webp"
                                            class="img-fluid" alt="Program">
                                    </div>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="col-lg-6 isotope-item filter-certificate" data-aos="zoom-in" data-aos-delay="100">
                        <div class="program-item">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <div class="program-image-wrapper">
                                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-2.webp"
                                            class="img-fluid" alt="Program">
                                    </div>
                                </div>
                                <div class="col-md-8">
            ...
            <div class="row align-items-center gy-4">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                    <div class="students-life-img position-relative">
                        <img src="{{ asset('NiceSchool') }}/assets/img/education/education-square-11.webp"
            ...
            <div class="testimonial-masonry">
                    ...
                    <div class="testimonial-content">
                        ...
                        <div class="client-info">
                            <div class="client-image">
                                <img src="{{ asset('NiceSchool') }}/assets/img/person/person-f-7.webp" alt="Client">
                            </div>
                ...
                <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="100">
                    <div class="testimonial-content">
                        ...
                        <div class="client-info">
                            <div class="client-image">
                                <img src="{{ asset('NiceSchool') }}/assets/img/person/person-m-7.webp" alt="Client">
                            </div>
                            <div class="client-details">
                                <h3>Daniel Morgan</h3>
                ...
                <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
                    <div class="testimonial-content">
                        ...
                        <div class="client-info">
                            <div class="client-image">
                                <img src="{{ asset('NiceSchool') }}/assets/img/person/person-f-8.webp" alt="Client">
                            </div>
                            <div class="client-details">
                                <h3>Emma Thompson</h3>
                ...
                <div class="testimonial-item" data-aos="fade-up" data-aos-delay="300">
                    <div class="testimonial-content">
                        ...
                        <div class="client-info">
                            <div class="client-image">
                                <img src="{{ asset('NiceSchool') }}/assets/img/person/person-m-8.webp" alt="Client">
                            </div>
                            <div class="client-details">
                ...
                <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="400">
                    <div class="testimonial-content">
                        ...
                        <div class="client-info">
                            <div class="client-image">
                                <img src="{{ asset('NiceSchool') }}/assets/img/person/person-f-9.webp" alt="Client">
                            </div>
                            <div class="client-details">
                                <h3>Olivia Carter</h3>
                ...
                <div class="testimonial-item" data-aos="fade-up" data-aos-delay="500">
                    <div class="testimonial-content">
                        ...
                        <div class="client-info">
                            <div class="client-image">
                                <img src="{{ asset('NiceSchool') }}/assets/img/person/person-m-13.webp" alt="Client">
                            </div>
                            <div class="client-details">
                                <h3>Nathan Brooks</h3>
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('NiceSchool') }}/assets/img/blog/blog-post-1.webp" alt=""
                                class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('NiceSchool') }}/assets/img/person/person-f-12.webp" alt=""
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('NiceSchool') }}/assets/img/blog/blog-post-2.webp" alt=""
                                class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('NiceSchool') }}/assets/img/person/person-f-13.webp" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('NiceSchool') }}/assets/img/blog/blog-post-3.webp" alt=""
                                class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('NiceSchool') }}/assets/img/person/person-m-10.webp" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
