...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('NiceSchool') }}/assets/img/favicon.png" rel="icon">
    <link href="{{ asset('NiceSchool') }}/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<body class="index-page">
    ...
    <script src="{{ asset('NiceSchool') }}/assets/vendor/php-email-form/validate.js"></script>
