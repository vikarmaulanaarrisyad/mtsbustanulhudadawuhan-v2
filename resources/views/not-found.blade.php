            ...
            <div class="account-form-inner">
                <div class="account-container">
                    <div class="error-page">
                        <h3 style="color:#e74c3c; margin-bottom:0; font-weight:700;">Ups!</h3>
                        <h2 class="error-title" style="font-size:96px; margin:10px 0; font-weight:900; color:#e74c3c;">
                            404</h2>
                        <h5 style="font-weight:600; margin-bottom:15px;">Halaman yang Anda cari tidak ditemukan.</h5>
                        <p style="color:#555; margin-bottom:30px; font-size:16px;">
                            Maaf, halaman yang Anda tuju mungkin sudah dihapus, namanya diubah, atau sedang tidak
                            tersedia.
                        </p>
                        <div class="">
